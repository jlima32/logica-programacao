...
// Problema: receber 3 notas d euma aluno 
...
nota1=parseInt(prompt('digite a nota 1:')); //parseint=converter o valor que estiver dentro (parametro) para numero inteiro
